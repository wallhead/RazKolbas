...
try:
 ...
 for label,rva,size in [('drs_control_candidate',0x643c00,0x100),('drs_policy_callee',0xe587f0,0x400),('scissor_candidate',0xe4adf0,0x180),('renderer_lock',0xe44550,32),('renderer_unlock',0xe44570,32),('renderer_begin',0xe44590,480),('renderer_end',0xe44770,512),('renderer_begin_target_callee',0xe4fb90,0x400),('renderer_begin_setup_callee',0xe4f180,0x200),('renderer_begin_reset_callee_a',0xe43bc0,0x100),('renderer_begin_reset_callee_b',0xe44050,0x100),('jitter_pair_first',0xe01ac0,0x100),('camera_source_pair_first',0xe01c90,0x240),('jitter_pair_second',0xe58a10,0x840),('camera_source_pair_second',0xe58b80,0x240),('pre_ui_candidate',0xfa4f00,0x1000),('ui_entry_claim_candidate',0xfa3dc0,0x400),('post_world_call',0xfc32e0,0x1000),('renderer',0x32887c0,0x2840),('graphics_state',0x328cc20,0x1000),('renderer_data_ptr',0x3286a08,8)]:
