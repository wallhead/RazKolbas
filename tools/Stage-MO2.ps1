...
$plugins = Join-Path $destinationPath 'Data/SKSE/Plugins'
...
@{ product='RazKolbas'; status='DEVELOPMENT_NATIVE_HOST_ONLY'; files=$files; uninstall='Remove only listed files whose hashes still match, or remove this isolated MO2 mod folder.' } |
